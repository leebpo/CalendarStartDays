...
//	public static String getLabel(int year, boolean easy) {
//		if (contains(yearsG, year)) 
//			return "G";
//		else if (contains(yearsF, year)) 
//			return "F";
//		else if (contains(yearsE, year)) 
//			return "E";
//		else if (contains(yearsD, year)) 
//			return "D";
//		else if (contains(yearsC, year)) 
//			return "C";
//		else if (contains(yearsB, year)) 
//			return "B";
//		else if (contains(yearsA, year)) 
//			return "A";
//		else if (contains(yearsGF, year)) 
//			return "GF";
//		else if (contains(yearsFE, year)) 
//			return "FE";
//		else if (contains(yearsED, year)) 
//			return "ED";
//		else if (contains(yearsDC, year)) 
//			return "DC";
//		else if (contains(yearsCB, year)) 
//			return "CB";
//		else if (contains(yearsBA, year)) 
//			return "BA";
//		else if (contains(yearsAG, year))
//			return "AG";
//		else return "Uh oh, it's in none of these groups.";
//	}
...
//			System.out.println(k + "\t" + getLabel(k));
		...
		//printList(sharedYears(1634, 8));
		
		getListByYear();
		//System.out.println(distFromLastSpecialCommonYear(2000));
	}
